...
export const CreateRoomButton = styled.button.attrs({
  className:
    "bg-blue-500 text-white px-4 py-3 rounded-full w-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200 text-lg font-semibold shadow-md",
})``;
